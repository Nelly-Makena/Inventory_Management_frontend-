  ...
  return (
      <div className="min-h-screen bg-background">
        ...
        <nav className="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-sm">
          <div className="container mx-auto flex min-h-16 flex-wrap items-center justify-between gap-3 px-4 py-3 sm:h-16 sm:flex-nowrap sm:py-0">
            <div className="flex items-center gap-3" data-aos="fade-right">
              <img
                  src={gearImage}
                  alt="StockKenya Profile"
                  className="h-9 w-9 sm:h-10 sm:w-10 rounded-full object-cover border-2 border-primary"
              />
              <div className="flex flex-col">
                <span className="text-base sm:text-lg font-bold text-foreground leading-none">StockKenya</span>
                <span className="hidden sm:inline text-xs text-muted-foreground">Inventory Management</span>
              </div>
            </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-start">
              <div className="space-y-8">
                <div className="space-y-4">
                  <h1
                      className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl lg:text-6xl"
                      data-aos="fade-up"
                      data-aos-delay="100"
                  >
                    Stop Worrying about{' '}
                  ...
                  <p className="text-base sm:text-lg text-primary font-semibold" data-aos="fade-up" data-aos-delay="200">
                    Protect Your Peace of Mind, Your Shop, and Start growing your business.
                  </p>
                  <p className="text-muted-foreground text-base sm:text-lg max-w-lg" data-aos="fade-up" data-aos-delay="300">
                ...
                <p className="text-sm text-muted-foreground" data-aos="fade-up" data-aos-delay="600">
                ...
                <div className="relative rounded-2xl border border-border bg-card p-2 shadow-2xl group">
                  <div className="rounded-xl bg-background p-4">
                    <div className="space-y-4">
                      ...
                      <div className="relative h-48 overflow-hidden rounded-lg image-reveal" data-aos="slide-left" data-aos-delay="200">
                        <img
                            src="/hero.jpeg"
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-xs">
                        {['Summary', "Today's Sales", "Yesterday's Sales", 'Sales by Employee'].map((tab, i) => (
                            <div key={tab} className="rounded-lg bg-muted px-2 py-2" data-aos="fade-up" data-aos-delay={300 + (i * 50)}>
                              {tab}
                            </div>
                        ))}
                      </div>
        ...
        <section id="features" className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16" data-aos="fade-up">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-4" data-aos="fade-down" data-aos-delay="100">
            ...
            <div className="space-y-24">
              {features.map((feature, index) => (
                  <div
                      key={feature.title}
                      className={`grid gap-8 lg:gap-12 lg:grid-cols-2 items-center ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}
                  >
                    {/* Image */}
                    <div
                    ...
                    >
                      <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
                        <img
                            ...
                            className="w-full h-64 sm:h-[360px] lg:h-[400px] object-cover transition-transform duration-700 group-hover:scale-110"
                        />
                    ...
                    >
                      <div className="space-y-6">
                        <div data-aos="fade-up" data-aos-delay="300">
                          ...
                          <h3 className="text-2xl font-bold text-foreground mb-3">{feature.description}</h3>
                        </div>

                        <ul className="space-y-3">
                          {feature.details.map((detail, i) => (
                              <li key={detail} className="flex items-start gap-3" data-aos="fade-up" data-aos-delay={400 + (i * 50)}>
                        ...
                        {/* button navigates to the feature's page */}
                        <Button
                            className="w-full sm:w-auto gap-2 group hover:bg-primary transition-colors"
                            size="lg"
              ...
              <div data-aos="fade-right" data-aos-duration="1000">
                ...
                <div className="space-y-4">
                  {benefits.map((benefit, index) => (
                      <div key={benefit} className="flex items-start gap-3" data-aos="fade-up" data-aos-delay={index * 100}>
        ...
        <footer className="border-t border-border py-8 mt-12">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4" data-aos="fade-up">
              <div className="flex items-center gap-2">
